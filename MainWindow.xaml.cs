...
namespace EyePlayerDemoWPF
{
    public partial class MainWindow : Window
    {
        ...
        Boolean hasGazedTimeStore = false;
        ...
        double realScreenHeight = 1800;
        double realScreenWidth = 2880;
        ...
        public void Reset()
        {
            ...
            if (userNotPresence == true)
            {
                ...
                if ((DateTime.Now - userPresenceTime).TotalSeconds > 5 && userPresenceTimeStore)
                {
                    ...
                    BgMusic.LoadedBehavior = MediaState.Stop;
        ...
        public void DrawBigEye()
        {
            ...
            Canvas.SetRight(leftEllipse, leftEyePosX * screenWidth * 1.1);
            Canvas.SetTop(rightEllipse, rightEyePosY * screenHeight);
            Canvas.SetRight(rightEllipse, rightEyePosX * screenWidth * 1.1);
            //Canvas.SetTop(eyePosText, screenHeight * 0.16);
            //Canvas.SetRight(eyePosText, screenWidth * 0.08);
        ...
        public void AppStart()
        {
            ...
            if (hasGazed == true)
            {
                appStartText1.Visibility = Visibility.Hidden;
                appStartText2.Visibility = Visibility.Visible;



                if (hasGazedTimeStore == false)
                {
                    startTime = DateTime.Now;
                    //BgMusic.LoadedBehavior = MediaState.Play;
                    successSound.LoadedBehavior = MediaState.Play;
                    hasGazedTimeStore = true;
                }
            ...
            {
                appStartText1.Visibility = Visibility.Visible;
                appStartText2.Visibility = Visibility.Hidden;
                hasGazedTimeStore = false;
        ...
        public void Scroll()
        {
            ...
            SetCursorPos(20, (int)realScreenHeight/3);


            

            if (posY < realScreenHeight / 3)
            {
                mouse_event(MOUSEEVENTF_WHEEL, 0, 0, (int)((realScreenHeight / 3 - posY) / 3) / 4, 0);
            ...
            else if (posY > realScreenHeight * 2 / 3)
            {
                mouse_event(MOUSEEVENTF_WHEEL, 0, 0, (int)((realScreenHeight * 2 / 3 - posY) / 3) / 4, 0);
        ...
        public void Click()
        {
            ...
            if (posX < realScreenWidth * 0.4 && posY < realScreenHeight * 0.5 && posX > 0 && posY > 0)
            {
            ...
            else if (posX > realScreenWidth * 0.4 && posY < realScreenHeight * 0.5 && posX < realScreenWidth * 0.8)
            {
            ...
            else if (posX < realScreenWidth * 0.4 && posY > realScreenHeight * 0.5)
            {
        ...
        private void closeWindows(object sender, System.Windows.Input.KeyEventArgs e)
        {
            if (e.Key == Key.Escape)
            {
                this.Close();
